...
public class CompletionPdfUtil {
	...
	private static Font getFont(float height) throws Exception {
		...
		String fontPath = request.getSession().getServletContext().getRealPath("/pdf/certificate/font/ChosunGs.ttf");
	...
	public static void createPdf(HttpServletResponse response, Map<String, Object> so) throws Exception {
		...
		String bgImgPath = getRealPath("/pdf/certificate/images/bg_certificate.gif");
		String fontPath2 = getRealPath("/pdf/certificate/font/ChosunGs.ttf");
...
//		Font font4 = new Font(baseFont2, 29);
		...
		Utilities.downloadFile(response, pdfFilePath, "지원서_" + DateUtil.getTodayDateTime("yyyyMMddHHmmss") + ".pdf", "application/pdf;charset=UTF-8");
