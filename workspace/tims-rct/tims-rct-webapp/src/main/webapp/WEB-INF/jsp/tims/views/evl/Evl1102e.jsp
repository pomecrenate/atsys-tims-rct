...
const sheetColumns = [
    ...
    { type: "select", name: "qstTypeNm", options: ["기초심사", "전공심사", "세미나", "면접"] },
...
function validateSheet() {
    ...
    $('#sheet-tbody tr').each(function() {
        ...
        const qstTypeNm = $tr.find('select[name="qstTypeNm"]').val();
        ...
        if (!sortOrder || !qstTypeNm || !qstNm || !qstScore || !indNm || !indScore) {
            alert("모든 항목을 입력해주세요.");
            isValid = false;
            return false;
        }
