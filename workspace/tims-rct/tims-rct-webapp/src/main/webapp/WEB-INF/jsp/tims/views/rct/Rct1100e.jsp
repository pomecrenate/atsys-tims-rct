...
<script>  
	const tbColNms = [
	  ...
	  { type: "button", name: "ntcMng", btnText: "공고관리", action: "moveTab"},
	]
	...
	$(document).ready(function() { 
		...
		RctUtil.loadPageData("${svnmSearch}", "", "ntcCd", "", "ntc-tbody");
	})  
