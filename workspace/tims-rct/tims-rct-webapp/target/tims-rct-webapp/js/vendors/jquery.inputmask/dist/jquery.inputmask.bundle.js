...
!function($) {
    ...
    return Inputmask.extendAliases({
        phone: {
            url: contextPath+"/tiles/gentelella/vendors/jquery.inputmask/extra/phone-codes/phone-codes.js",
            countrycode: "",
            phoneCodeCache: {},
            mask: function(opts) {
        ...
        phonebe: {
            alias: "phone",
            url: contextPath+"/tiles/gentelella/vendors/jquery.inputmask/extra/phone-codes/phone-be.js",
            countrycode: "32",
            nojumpsThreshold: 4
        }
    }), Inputmask;
