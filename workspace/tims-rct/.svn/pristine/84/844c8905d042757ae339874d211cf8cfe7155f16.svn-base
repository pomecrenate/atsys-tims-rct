...
public class Evl1202eController {
	...
	@RequestMapping(value="/popup/saveEvalSch")
	public String popupSaveEvalSch(@RequestParam Map<String, Object> so, Model model, HttpSession session) throws Exception {  
