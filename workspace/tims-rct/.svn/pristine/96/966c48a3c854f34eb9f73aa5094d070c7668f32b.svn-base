...
public class Rcp1100eController {
	...
	public String popupUpldFileList(@RequestParam Map<String, Object> so, Model model, HttpSession session) throws Exception {  
		return upldFileListPop;
	}  
	
	@RequestMapping(value="/popup/appDetail/{appCd}")
	public ModelAndView popupAppDetail(@PathVariable(value = "appCd") String appCd, HttpSession session) throws Exception {
	    session.setAttribute("userRole", "ADMIN");
